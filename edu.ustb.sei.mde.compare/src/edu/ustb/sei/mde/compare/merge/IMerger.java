...
public interface IMerger {
	...
	class RegistryImpl implements Registry2 {
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.merge.IMerger.Registry#add(edu.ustb.sei.mde.compare.merge.IMerger)
		 */
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.merge.IMerger.Registry#remove(java.lang.String)
		 */
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.merge.IMerger.Registry#clear()
		 */
		public void clear() {
			map.clear();
		}
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.merge.IMerger.Registry#getHighestRankingMerger(edu.ustb.sei.mde.compare.Diff)
		 */
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.merge.IMerger.Registry#getMergers(edu.ustb.sei.mde.compare.Diff)
		 */
