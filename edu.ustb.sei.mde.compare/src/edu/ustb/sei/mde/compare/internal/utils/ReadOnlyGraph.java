 ...
 *******************************************************************************/
package edu.ustb.sei.mde.compare.internal.utils;

import com.google.common.collect.ImmutableSet;

import java.util.Set;

import edu.ustb.sei.mde.compare.graph.IGraph;
import edu.ustb.sei.mde.compare.graph.IGraphView;
import edu.ustb.sei.mde.compare.graph.PruningIterator;

/**
 * Read-only version of an already existing {@link edu.ustb.sei.mde.compare.internal.utils.Graph}.
 * 
 * @param <E>
...
public final class ReadOnlyGraph<E> implements IGraphView<E> {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#contains(Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#hasChild(Object, Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getDirectParents(Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getParentData(Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getSubgraphContaining(Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getSubgraphContaining(Object, ImmutableSet)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getTreeFrom(Object)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#getTreeFrom(Object, Set)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.graph.IGraphView#breadthFirstIterator()
	 */
