...
import edu.ustb.sei.mde.compare.internal.utils.Graph;
import edu.ustb.sei.mde.compare.merge.AbstractMerger;
import edu.ustb.sei.mde.compare.merge.IMergeOptionAware;
import edu.ustb.sei.mde.compare.merge.IMerger;
import edu.ustb.sei.mde.compare.merge.IMerger2;
...
public final class MergeDependenciesUtil {
	 ...
	 * @see #mapDifferences(Collection, edu.ustb.sei.mde.compare.merge.IMerger.Registry, boolean, MergeMode)
	 */
