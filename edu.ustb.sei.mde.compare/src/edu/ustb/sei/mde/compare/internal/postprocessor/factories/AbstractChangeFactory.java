 ...
 *******************************************************************************/
package edu.ustb.sei.mde.compare.internal.postprocessor.factories;
...
public abstract class AbstractChangeFactory implements IChangeFactory {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.internal.postprocessor.factories.IChangeFactory#handles(edu.ustb.sei.mde.compare.Diff)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.internal.postprocessor.factories.IChangeFactory#create(edu.ustb.sei.mde.compare.Diff)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.internal.postprocessor.factories.IChangeFactory#getParentMatch(edu.ustb.sei.mde.compare.Diff)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.internal.postprocessor.factories.IChangeFactory#getExtensionKind()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see edu.ustb.sei.mde.compare.internal.postprocessor.factories.IChangeFactory#fillRequiredDifferences(edu.ustb.sei.mde.compare.Comparison,
	 *      edu.ustb.sei.mde.compare.Diff)
	 */
	...
	private class DifferenceKindCompareSwitch extends CompareSwitch<DifferenceKind> {
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.util.CompareSwitch#caseAttributeChange(edu.ustb.sei.mde.compare.AttributeChange)
		 */
		@Override
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.util.CompareSwitch#caseReferenceChange(edu.ustb.sei.mde.compare.ReferenceChange)
		 */
		@Override
		 ...
		 * {@inheritDoc}
		 * 
		 * @see edu.ustb.sei.mde.compare.util.CompareSwitch#caseResourceAttachmentChange(edu.ustb.sei.mde.compare.ResourceAttachmentChange)
		 */
		@Override
