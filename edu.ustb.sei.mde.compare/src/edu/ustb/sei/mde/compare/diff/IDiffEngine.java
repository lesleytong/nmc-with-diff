 ...
 * {@link edu.ustb.sei.mde.compare.Match} it finds with all differences that can be detected on its sides. The
...
public interface IDiffEngine {
	 ...
	 * {@link edu.ustb.sei.mde.compare.Match matches} it contain, filling in the differences it can detect for
	 * each distinct Match.
	 * </p>
	 * 
	 * @param comparison
