 ...
 * {@link edu.ustb.sei.mde.compare.Diff} it finds with all required differences that can be detected on its
 * sides.
 * </p>
 * <p>
...
public interface IReqEngine {
	 ...
	 * {@link edu.ustb.sei.mde.compare.Diff differences} it contains, filling in the requirements it can detect
