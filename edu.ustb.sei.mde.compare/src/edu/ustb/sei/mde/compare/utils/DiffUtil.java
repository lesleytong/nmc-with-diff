...
public final class DiffUtil {
	...
	public static double diceCoefficient(String first, String second) {
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.diceCoefficient(first, second);
	}
	...
	public static <E> List<E> longestCommonSubsequence(Comparison comparison, Iterable<E> ignoredElements,
		...
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.longestCommonSubsequence(comparison,
	...
	public static <E> List<E> longestCommonSubsequence(Comparison comparison, List<E> sequence1,
			List<E> sequence2) {
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.longestCommonSubsequence(comparison, sequence1,
				sequence2);
	}
	...
	public static <E> int findInsertionIndex(Comparison comparison, Iterable<E> ignoredElements,
		...
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.findInsertionIndex(comparison, ignoredElements,
	...
	public static <E> int findInsertionIndex(Comparison comparison, List<E> source, List<E> target,
			E newElement) {
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.findInsertionIndex(comparison, source, target,
				newElement);
	}
	...
	public static int findInsertionIndex(Comparison comparison, Diff diff, boolean rightToLeft) {
		return edu.ustb.sei.mde.compare.internal.utils.DiffUtil.findInsertionIndex(comparison, diff,
				rightToLeft);
	}
	 ...
	 * <p>
	 * If the diff is an {@link edu.ustb.sei.mde.compare.AttributeChange}, a
	 * {@link edu.ustb.sei.mde.compare.FeatureMapChange} or a @{code ResourceAttachmentChange}, this method
	 * will return an empty iterable.
	 * </p>
	 * <p>
	 * If the diff is a {@link edu.ustb.sei.mde.compare.ReferenceChange} this method will return all
