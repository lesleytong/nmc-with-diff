...
import edu.ustb.sei.mde.compare.diff.DiffBuilder;
import edu.ustb.sei.mde.compare.diff.IDiffEngine;
import edu.ustb.sei.mde.compare.equi.DefaultEquiEngine;
import edu.ustb.sei.mde.compare.equi.IEquiEngine;
import edu.ustb.sei.mde.compare.internal.spec.ComparisonSpec;
import edu.ustb.sei.mde.compare.internal.utils.SafeSubMonitor;
...
import edu.ustb.sei.mde.compare.postprocessor.IPostProcessor;
import edu.ustb.sei.mde.compare.postprocessor.PostProcessorDescriptorRegistryImpl;
import edu.ustb.sei.mde.compare.req.DefaultReqEngine;
import edu.ustb.sei.mde.compare.req.IReqEngine;
...
public class EMFCompare {
	...
	public Comparison compare(IComparisonScope scope) {
		...
		System.out.println(basicMonitor);

		return compare(scope, basicMonitor);
	}
	...
	// lyt
	public void compareADD(Comparison comparisonADD, IComparisonScope scope, List<EObject> leftEObjects,
