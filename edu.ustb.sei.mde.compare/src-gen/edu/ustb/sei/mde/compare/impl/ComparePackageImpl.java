...
import edu.ustb.sei.mde.compare.ResourceLocationChange;
...
public class ComparePackageImpl extends EPackageImpl implements ComparePackage {
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(
				...
				this.getResourceLocationChange(),
				null,
				"locationChanges", null, 0, 2, MatchResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(
				...
				this.getMatch(),
				null,
				"match", null, 0, 1, Diff.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getDiff_Requires(),
				this.getDiff(),
		...
		initEClass(resourceLocationChangeEClass, ResourceLocationChange.class,
				"ResourceLocationChange", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getResourceLocationChange_BaseLocation(),
				ecorePackage.getEString(),
				"baseLocation", null, 1, 1, ResourceLocationChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getResourceLocationChange_ChangedLocation(),
				ecorePackage.getEString(),
				"changedLocation", null, 1, 1, ResourceLocationChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
