 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.compare.Match#getSubmatches <em>Submatches</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.Match#getDifferences <em>Differences</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.Match#getLeft <em>Left</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.Match#getRight <em>Right</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.Match#getOrigin <em>Origin</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch()
 * @model
 * @generated
 */
public interface Match extends EObject {
	 ...
	 * The list contents are of type {@link edu.ustb.sei.mde.compare.Match}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch_Submatches()
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch_Differences()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see #setLeft(EObject)
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch_Left()
	 * @model
	 * @generated
	 */
	EObject getLeft();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.Match#getLeft <em>Left</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch_Right()
	 * @model
	 * @generated
	 */
	EObject getRight();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.Match#getRight <em>Right</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatch_Origin()
	 * @model
	 * @generated
	 */
	EObject getOrigin();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.Match#getOrigin <em>Origin</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
