 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getLeftURI <em>Left URI</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getRightURI <em>Right URI</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getOriginURI <em>Origin URI</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getLeft <em>Left</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getRight <em>Right</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getOrigin <em>Origin</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getComparison <em>Comparison</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.compare.MatchResource#getLocationChanges <em>Location Changes</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource()
 * @model
 * @generated
 */
public interface MatchResource extends EObject {
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_LeftURI()
	 * @model required="true"
	 * @generated
	 */
	String getLeftURI();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getLeftURI <em>Left URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_RightURI()
	 * @model required="true"
	 * @generated
	 */
	String getRightURI();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getRightURI <em>Right URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_OriginURI()
	 * @model
	 * @generated
	 */
	String getOriginURI();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getOriginURI <em>Origin URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_Left()
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getLeft <em>Left</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_Right()
	 * @model transient="true"
	 * @generated
	 */
	Resource getRight();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getRight <em>Right</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_Origin()
	 * @model transient="true"
	 * @generated
	 */
	Resource getOrigin();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getOrigin <em>Origin</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link edu.ustb.sei.mde.compare.Comparison#getMatchedResources <em>Matched Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_Comparison()
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.MatchResource#getComparison <em>Comparison</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link edu.ustb.sei.mde.compare.ResourceLocationChange}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getMatchResource_LocationChanges()
