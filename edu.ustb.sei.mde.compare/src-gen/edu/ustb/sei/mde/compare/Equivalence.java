 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.compare.Equivalence#getDifferences <em>Differences</em>}</li>
 * </ul>
 * </p>
 *
 * @see edu.ustb.sei.mde.compare.ComparePackage#getEquivalence()
 * @model
 * @generated
 */
public interface Equivalence extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link edu.ustb.sei.mde.compare.Diff#getEquivalence <em>Equivalence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getEquivalence_Differences()
