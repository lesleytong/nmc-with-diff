 ...
 * <ul>
 * <li>{@link edu.ustb.sei.mde.compare.Comparison#getMatchedResources <em>Matched Resources</em>}</li>
 * <li>{@link edu.ustb.sei.mde.compare.Comparison#getMatches <em>Matches</em>}</li>
 * <li>{@link edu.ustb.sei.mde.compare.Comparison#getConflicts <em>Conflicts</em>}</li>
 * <li>{@link edu.ustb.sei.mde.compare.Comparison#getEquivalences <em>Equivalences</em>}</li>
 * <li>{@link edu.ustb.sei.mde.compare.Comparison#isThreeWay <em>Three Way</em>}</li>
 * </ul>
 * </p>
 * 
 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison()
 * @model
 * @generated
 */
public interface Comparison extends EObject {
	 ...
	 * contents are of type {@link edu.ustb.sei.mde.compare.MatchResource}. <!-- begin-user-doc --> <!--
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_MatchedResources()
	 ...
	 * type {@link edu.ustb.sei.mde.compare.Match}. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_Matches()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * of type {@link edu.ustb.sei.mde.compare.Conflict}. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_Conflicts()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * are of type {@link edu.ustb.sei.mde.compare.Equivalence}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_Equivalences()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_ThreeWay()
	 * @model
	 * @generated
	 */
	boolean isThreeWay();
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.Comparison#isThreeWay <em>Three Way</em>}'
	 ...
	 * @see edu.ustb.sei.mde.compare.ComparePackage#getComparison_Diagnostic()
	...
	/**
	 * Sets the value of the '{@link edu.ustb.sei.mde.compare.Comparison#getDiagnostic <em>Diagnostic</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
